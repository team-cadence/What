...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { checked: @list_item.checked, label: @list_item.label, list_id: @list_item.list_id }
    end
  ...
  test "should update list_item" do
    patch :update, id: @list_item, list_item: { checked: @list_item.checked, label: @list_item.label, list_id: @list_item.list_id }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
